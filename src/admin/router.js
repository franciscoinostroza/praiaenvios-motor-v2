...
function renderNav(active) {
  const items = [
    ...
    { divider: true },
    { label: 'Trechos LATAM', path: '/admin/trechos_config', icon: '🛫', key: 'Trechos LATAM' },
    { label: 'Configuración de Texto', path: '/admin/config_texto', icon: '📝', key: 'Configuración de Texto' },
    { divider: true },
